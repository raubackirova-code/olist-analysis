...
### Динамика среднего чека помесяцам
График отражает изменение покпательского поведения во времени.
[Изменения среднего чека](images/images/avg_orders_dynamic.png)
### Вклад TOP-5 категорий товаров в выручку по времени 
График иллюстрирует вклад наиболее значимыч категорий товаров по объёму выручки по времени.
